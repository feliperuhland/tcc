...
Mais de dois terços das aplicações web rodam em ambiente unix, segundo (http://w3techs.com/technologies/overview/operating_system/all). As maneiras para utilizar estes sistemas são por meio de servidores dedicados ou virtualizados. Os servidores dedicados são a maneira mais natural de servir uma aplicação web.
