...
% **************************************************
\titulo{\uppercase{Uma análise sobre a aplicação do design thinking  \\ na educação}}
\autor{\uppercase{Fulano de Tal}}
...
Neste capítulo são apresentados trabalhos relacionados que sejam relevantes para a pesquisa. Isso é um exemplo de citação \cite[p. 10]{van86}. Os dados de cada citação devem ser inseridos no arquivo \textit{alterar/referencias.bib}.
